...
#> The outliers table will be written at  /tmp/RtmpUq6KOD/outliers-table1ec869203bb3.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpUq6KOD/outliers-table1ec869203bb3.yaml 
...
#> The td table will be written at /tmp/RtmpUq6KOD/td-table1ec82fa1301.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpUq6KOD/td-table1ec82fa1301.yaml 
