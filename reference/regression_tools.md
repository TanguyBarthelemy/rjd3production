...
#> The outliers table will be written at  /tmp/RtmpcXQXFt/outliers-table1fed33aebe39.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpcXQXFt/outliers-table1fed33aebe39.yaml 
...
#> The td table will be written at  /tmp/RtmpcXQXFt/td-table1fed162f6ccf.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpcXQXFt/td-table1fed162f6ccf.yaml 
