...
#> The outliers table will be written at  /tmp/RtmpkNOqKv/outliers-table1f083109b1a6.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpkNOqKv/outliers-table1f083109b1a6.yaml 
...
#> The td table will be written at /tmp/RtmpkNOqKv/td-table1f08692248e8.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpkNOqKv/td-table1f08692248e8.yaml 
