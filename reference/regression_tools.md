...
#> The outliers table will be written at  /tmp/Rtmpd2A5Wi/outliers-table200e38e693e3.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/Rtmpd2A5Wi/outliers-table200e38e693e3.yaml 
...
#> The td table will be written at  /tmp/Rtmpd2A5Wi/td-table200e3d87bf87.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/Rtmpd2A5Wi/td-table200e3d87bf87.yaml 
