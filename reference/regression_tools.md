...
#> The outliers table will be written at  /tmp/RtmpsIWjOM/outliers-table21b91d5101f4.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpsIWjOM/outliers-table21b91d5101f4.yaml 
...
#> The td table will be written at /tmp/RtmpsIWjOM/td-table21b983a3ec7.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpsIWjOM/td-table21b983a3ec7.yaml 
