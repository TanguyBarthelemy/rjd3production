...
#> The outliers table will be written at  /tmp/RtmpzVBfIa/outliers-table1fcb38f231b6.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpzVBfIa/outliers-table1fcb38f231b6.yaml 
...
#> The td table will be written at  /tmp/RtmpzVBfIa/td-table1fcb6517e105.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpzVBfIa/td-table1fcb6517e105.yaml 
