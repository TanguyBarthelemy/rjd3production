...
#> The outliers table will be written at  /tmp/RtmpGNqsLe/outliers-table206457ca33f1.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpGNqsLe/outliers-table206457ca33f1.yaml 
...
#> The td table will be written at  /tmp/RtmpGNqsLe/td-table20643e12bbca.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpGNqsLe/td-table20643e12bbca.yaml 
