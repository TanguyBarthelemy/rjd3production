...
#> The outliers table will be written at  /tmp/RtmpgzIIek/outliers-table242e5453c839.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpgzIIek/outliers-table242e5453c839.yaml 
...
#> The td table will be written at  /tmp/RtmpgzIIek/td-table242e1da39234.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpgzIIek/td-table242e1da39234.yaml 
