...
#> The outliers table will be written at  /tmp/Rtmpkr33VW/outliers-table200e5297b8a3.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/Rtmpkr33VW/outliers-table200e5297b8a3.yaml 
...
#> The td table will be written at  /tmp/Rtmpkr33VW/td-table200e411a92b5.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/Rtmpkr33VW/td-table200e411a92b5.yaml 
