...
#> The outliers table will be written at  /tmp/Rtmp2EhWgp/outliers-table1e527ab1e64a.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/Rtmp2EhWgp/outliers-table1e527ab1e64a.yaml 
...
#> The td table will be written at /tmp/Rtmp2EhWgp/td-table1e523ca4aa5.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/Rtmp2EhWgp/td-table1e523ca4aa5.yaml 
