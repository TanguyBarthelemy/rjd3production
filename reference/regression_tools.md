...
#> The outliers table will be written at  /tmp/RtmpKoG0Nc/outliers-table1f5567050f27.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpKoG0Nc/outliers-table1f5567050f27.yaml 
...
#> The td table will be written at /tmp/RtmpKoG0Nc/td-table1f553df2d723.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpKoG0Nc/td-table1f553df2d723.yaml 
