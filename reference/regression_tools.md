...
#> The outliers table will be written at  /tmp/RtmpdAPNMY/outliers-table22a0933b585.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpdAPNMY/outliers-table22a0933b585.yaml 
...
#> The td table will be written at /tmp/RtmpdAPNMY/td-table22a0609bfafe.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpdAPNMY/td-table22a0609bfafe.yaml 
