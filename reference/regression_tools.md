...
#> The outliers table will be written at  /tmp/RtmpBTtEj9/outliers-table203010d2d916.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpBTtEj9/outliers-table203010d2d916.yaml 
...
#> The td table will be written at /tmp/RtmpBTtEj9/td-table20301dcbaa70.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpBTtEj9/td-table20301dcbaa70.yaml 
