...
#> The outliers table will be written at  /tmp/RtmpnDKsW2/outliers-table1f4230e1b7c8.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpnDKsW2/outliers-table1f4230e1b7c8.yaml 
...
#> The td table will be written at /tmp/RtmpnDKsW2/td-table1f4246329172.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpnDKsW2/td-table1f4246329172.yaml 
