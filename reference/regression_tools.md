...
#> The outliers table will be written at  /tmp/RtmpWwsRS3/outliers-table1f0f602941c4.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpWwsRS3/outliers-table1f0f602941c4.yaml 
...
#> The td table will be written at /tmp/RtmpWwsRS3/td-table1f0fe0beae3.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpWwsRS3/td-table1f0fe0beae3.yaml 
