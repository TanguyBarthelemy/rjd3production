...
#> The outliers table will be written at  /tmp/Rtmp9QAFX3/outliers-table1efb5592f67b.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/Rtmp9QAFX3/outliers-table1efb5592f67b.yaml 
...
#> The td table will be written at /tmp/Rtmp9QAFX3/td-table1efb6c256786.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/Rtmp9QAFX3/td-table1efb6c256786.yaml 
