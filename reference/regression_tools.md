...
#> The outliers table will be written at  /tmp/Rtmp7nTPNa/outliers-table20912e52b35b.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/Rtmp7nTPNa/outliers-table20912e52b35b.yaml 
...
#> The td table will be written at /tmp/Rtmp7nTPNa/td-table20913e651298.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/Rtmp7nTPNa/td-table20913e651298.yaml 
