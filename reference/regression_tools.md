...
#> The outliers table will be written at  /tmp/RtmpEoY9H4/outliers-table20314c3886f6.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpEoY9H4/outliers-table20314c3886f6.yaml 
...
#> The td table will be written at  /tmp/RtmpEoY9H4/td-table20314459541f.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpEoY9H4/td-table20314459541f.yaml 
