...
#> The outliers table will be written at  /tmp/RtmprK0mkC/outliers-table1f152452f025.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmprK0mkC/outliers-table1f152452f025.yaml 
...
#> The td table will be written at /tmp/RtmprK0mkC/td-table1f1542ffba47.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmprK0mkC/td-table1f1542ffba47.yaml 
