...
#> The outliers table will be written at  /tmp/RtmpOwLpM6/outliers-table200a3c23cc9d.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpOwLpM6/outliers-table200a3c23cc9d.yaml 
...
#> The td table will be written at /tmp/RtmpOwLpM6/td-table200a473d56a8.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpOwLpM6/td-table200a473d56a8.yaml 
