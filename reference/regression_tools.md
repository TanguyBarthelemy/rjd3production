...
#> The outliers table will be written at  /tmp/Rtmpxd978Z/outliers-table22a3463cc895.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/Rtmpxd978Z/outliers-table22a3463cc895.yaml 
...
#> The td table will be written at /tmp/Rtmpxd978Z/td-table22a378d8e948.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/Rtmpxd978Z/td-table22a378d8e948.yaml 
