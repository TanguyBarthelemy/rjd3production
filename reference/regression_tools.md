...
#> The outliers table will be written at  /tmp/Rtmpz2D5gc/outliers-table1f1e4900a98.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/Rtmpz2D5gc/outliers-table1f1e4900a98.yaml 
...
#> The td table will be written at /tmp/Rtmpz2D5gc/td-table1f1e53f21a6.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/Rtmpz2D5gc/td-table1f1e53f21a6.yaml 
