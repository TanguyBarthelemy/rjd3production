...
#> The outliers table will be written at  /tmp/RtmpOwIeAd/outliers-table24be14c55b01.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpOwIeAd/outliers-table24be14c55b01.yaml 
...
#> The td table will be written at  /tmp/RtmpOwIeAd/td-table24be6567b6a9.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpOwIeAd/td-table24be6567b6a9.yaml 
