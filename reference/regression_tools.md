...
#> The outliers table will be written at  /tmp/RtmpeAkgdT/outliers-table225d2e62ae00.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpeAkgdT/outliers-table225d2e62ae00.yaml 
...
#> The td table will be written at /tmp/RtmpeAkgdT/td-table225d45bd3955.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpeAkgdT/td-table225d45bd3955.yaml 
