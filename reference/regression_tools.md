...
#> The outliers table will be written at  /tmp/RtmpcoedJr/outliers-table269119236af1.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpcoedJr/outliers-table269119236af1.yaml 
...
#> The td table will be written at  /tmp/RtmpcoedJr/td-table26912651197f.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpcoedJr/td-table26912651197f.yaml 
