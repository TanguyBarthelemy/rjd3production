...
#> The outliers table will be written at  /tmp/Rtmpc1tpJp/outliers-table25de55d256f1.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/Rtmpc1tpJp/outliers-table25de55d256f1.yaml 
...
#> The td table will be written at  /tmp/Rtmpc1tpJp/td-table25de33e1b01f.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/Rtmpc1tpJp/td-table25de33e1b01f.yaml 
