...
#> The outliers table will be written at  /tmp/RtmpakRWSm/outliers-table22504f00d702.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpakRWSm/outliers-table22504f00d702.yaml 
...
#> The td table will be written at /tmp/RtmpakRWSm/td-table22504764a635.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpakRWSm/td-table22504764a635.yaml 
