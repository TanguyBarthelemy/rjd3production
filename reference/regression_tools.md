...
#> The outliers table will be written at  /tmp/RtmpufgFlY/outliers-table209114339d6.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpufgFlY/outliers-table209114339d6.yaml 
...
#> The td table will be written at  /tmp/RtmpufgFlY/td-table2091331f7f96.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpufgFlY/td-table2091331f7f96.yaml 
