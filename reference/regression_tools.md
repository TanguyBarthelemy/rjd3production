...
#> The outliers table will be written at  /tmp/RtmpFWxoAV/outliers-table203f768628e4.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpFWxoAV/outliers-table203f768628e4.yaml 
...
#> The td table will be written at /tmp/RtmpFWxoAV/td-table203f4c561b0e.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpFWxoAV/td-table203f4c561b0e.yaml 
