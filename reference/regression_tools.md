...
#> The outliers table will be written at  /tmp/RtmpXakFcB/outliers-table20757ac9197f.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpXakFcB/outliers-table20757ac9197f.yaml 
...
#> The td table will be written at  /tmp/RtmpXakFcB/td-table20756c86bda8.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpXakFcB/td-table20756c86bda8.yaml 
