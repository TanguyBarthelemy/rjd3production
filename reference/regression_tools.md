...
#> The outliers table will be written at  /tmp/RtmphE4imM/outliers-table22757fe8a34e.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmphE4imM/outliers-table22757fe8a34e.yaml 
...
#> The td table will be written at /tmp/RtmphE4imM/td-table22759519cf6.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmphE4imM/td-table22759519cf6.yaml 
