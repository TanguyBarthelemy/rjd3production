...
#> The outliers table will be written at  /tmp/RtmpOERRBm/outliers-table2688664db5e0.yaml 

# Import outliers from a file
outs2 <- import_outliers(path_outs)
#> The outliers table will be read at  /tmp/RtmpOERRBm/outliers-table2688664db5e0.yaml 
...
#> The td table will be written at  /tmp/RtmpOERRBm/td-table26886a0ebcf6.yaml 

# Import td variable from a file
td2 <- import_td(path_td)
#> The td table will be read at  /tmp/RtmpOERRBm/td-table26886a0ebcf6.yaml 
