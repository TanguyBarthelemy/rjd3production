...
- [`assign_outliers()`](https://inseefr.github.io/rjd3production/reference/assign_outliers.md)
  : Assign outliers to a JDemetra+ workspace
- [`assign_td()`](https://inseefr.github.io/rjd3production/reference/assign_td.md)
...
- [`select_regs()`](https://inseefr.github.io/rjd3production/reference/select_regs.md)
...
- [`export_td()`](https://inseefr.github.io/rjd3production/reference/td_tools.md)
